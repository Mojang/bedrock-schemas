 ...
 * 
 * Biome Components Documentation - minecraft:biome_definition
 */
...
export interface BiomeDefinitionComponents {
   ...
   * using them.
   */
  "minecraft:subsurface_builder"?: BiomeDefinitionComponentsMinecraftSubsurfaceBuilder;
...
taiga: Biomes tagged "forest" or "forest_generation" will
   ...
   */
  "minecraft:village_type"?: BiomeDefinitionComponentsMinecraftVillageType;
 ...
 * biome.
 */
export interface BiomeDefinitionComponentsMinecraftHumidity {
 ...
 * on the map.
 */
export interface BiomeDefinitionComponentsMinecraftMapTints {
 ...
 * JSON object.
 */
export interface BiomeDefinitionComponentsMinecraftMountainParametersMaterial {
...
export enum BiomeDefinitionComponentsMinecraftVillageTypeType {
  default = `default`,
  desert = `desert`,
  ice = `ice`,
  savanna = `savanna`,
