 ...
 * 
 * Biome Components Documentation - minecraft:biome_components
 */
 ...
 */
export default interface BiomeComponents {
   ...
   */
  "minecraft:climate"?: BiomeComponentsMinecraftClimate;
   ...
   * chunk is generated.
   */
  "minecraft:creature_spawn_probability"?: BiomeComponentsMinecraftCreatureSpawnProbability;
   ...
   * biome
   */
  "minecraft:humidity"?: BiomeComponentsMinecraftHumidity;
   ...
   * on the map.
   */
  "minecraft:map_tints"?: BiomeComponentsMinecraftMapTints;
   ...
   * Overworld.
   */
  "minecraft:mountain_parameters"?: BiomeComponentsMinecraftMountainParameters;
   ...
   */
  "minecraft:multinoise_generation_rules"?: BiomeComponentsMinecraftMultinoiseGenerationRules;
   ...
   */
  "minecraft:overworld_generation_rules"?: BiomeComponentsMinecraftOverworldGenerationRules;
   ...
   * Overworld.
   */
  "minecraft:overworld_height"?: BiomeComponentsMinecraftOverworldHeight;
   ...
   * biomes.
   */
  "minecraft:replace_biomes"?: BiomeComponentsMinecraftReplaceBiomes;
   ...
   */
  "minecraft:surface_builder"?: BiomeComponentsMinecraftSurfaceBuilder;
   ...
   * on a noise function).
   */
  "minecraft:surface_material_adjustments"?: BiomeComponentsMinecraftSurfaceMaterialAdjustments;
...
taiga: Biomes tagged "forest" or "forest_generation" will
   ...
   */
  "minecraft:village_type"?: BiomeComponentsMinecraftVillageType;
 ...
 */
export interface BiomeComponentsMinecraftClimate {
 ...
 * chunk is generated.
 */
export interface BiomeComponentsMinecraftCreatureSpawnProbability {
 ...
 * biome.
 */
export interface BiomeComponentsMinecraftHumidity {
 ...
 * on the map.
 */
export interface BiomeComponentsMinecraftMapTints {
 ...
 * Overworld.
 */
export interface BiomeComponentsMinecraftMountainParameters {
   ...
   */
  material?: BiomeComponentsMinecraftMountainParametersMaterial;
   ...
   */
  steep_material_adjustment?: BiomeComponentsMinecraftMountainParametersSteepMaterialAdjustment;
   ...
   */
  top_slide?: BiomeComponentsMinecraftMountainParametersTopSlide;
 ...
 * JSON object.
 */
export interface BiomeComponentsMinecraftMountainParametersMaterial {
 ...
 * Defines surface material for steep slopes.
 */
export interface BiomeComponentsMinecraftMountainParametersSteepMaterialAdjustment {
 ...
 * world to prevent terrain from reaching too high.
 */
export interface BiomeComponentsMinecraftMountainParametersTopSlide {
 ...
 * custom biomes.
 */
export interface BiomeComponentsMinecraftMultinoiseGenerationRules {
 ...
 * custom biomes.
 */
export interface BiomeComponentsMinecraftOverworldGenerationRules {
 ...
 * rendering.
 */
export interface BiomeComponentsMinecraftOverworldHeight {
...
export enum BiomeComponentsMinecraftOverworldHeightNoiseType {
  beach = `beach`,
 ...
 * biomes.
 */
export interface BiomeComponentsMinecraftReplaceBiomes {
   ...
   * of the list.
   */
  replacements: BiomeComponentsMinecraftReplaceBiomesReplacements[];
...
export interface BiomeComponentsMinecraftReplaceBiomesReplacements {
  ...
  /**
   * @remarks
   * Dimension in which this replacement can happen. Can be either
 ...
 * generation.
 */
export interface BiomeComponentsMinecraftSubsurfaceBuilderBuilder {
...
export enum BiomeComponentsMinecraftSubsurfaceBuilderBuilderType {
 ...
 * generation.
 */
export interface BiomeComponentsMinecraftSurfaceBuilderBuilder {
...
export enum BiomeComponentsMinecraftSurfaceBuilderBuilderType {
  minecraftCapped = `minecraft:capped`,
  minecraftFrozenOcean = `minecraft:frozen_ocean`,
  minecraftMesa = `minecraft:mesa`,
  minecraftOverworld = `minecraft:overworld`,
 ...
 * on a noise function).
 */
export interface BiomeComponentsMinecraftSurfaceMaterialAdjustments {
   ...
   */
  adjustments?: BiomeComponentsMinecraftSurfaceMaterialAdjustmentsAdjustments[];
 ...
 */
export interface BiomeComponentsMinecraftSurfaceMaterialAdjustmentsAdjustments {
   ...
   */
  materials: BiomeComponentsMinecraftSurfaceMaterialAdjustmentsAdjustmentsMaterials;
 ...
 * The specific blocks used for this surface adjustment.
 */
export interface BiomeComponentsMinecraftSurfaceMaterialAdjustmentsAdjustmentsMaterials {
 ...
 * use normal Overworld flowers instead of forest flowers.
 */
export interface BiomeComponentsMinecraftTags {
...
export enum BiomeComponentsMinecraftVillageTypeType {
  default = `default`,
  desert = `desert`,
  ice = `ice`,
  savanna = `savanna`,
