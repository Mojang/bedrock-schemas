 ...
 * 
 * Biome Components Documentation - minecraft:biome_json_file
 */
...
taiga: Biomes tagged "forest" or "forest_generation" will
   ...
   */
  "minecraft:village_type"?: BiomeJSONFileMinecraftBiomeComponentsMinecraftVillageType;
...
export enum BiomeJSONFileMinecraftBiomeComponentsMinecraftOverworldHeightNoiseType {
  beach = `beach`,
...
export enum BiomeJSONFileMinecraftBiomeComponentsMinecraftSurfaceBuilderBuilderType {
  minecraftCapped = `minecraft:capped`,
  minecraftFrozenOcean = `minecraft:frozen_ocean`,
  minecraftMesa = `minecraft:mesa`,
  minecraftNoiseGradient = `minecraft:noise_gradient`,
 ...
 * Determines the type of village for the Biome.
 */
export interface BiomeJSONFileMinecraftBiomeComponentsMinecraftVillageType {
...
export enum BiomeJSONFileMinecraftBiomeComponentsMinecraftVillageTypeType {
  default = `default`,
  desert = `desert`,
  ice = `ice`,
  savanna = `savanna`,
