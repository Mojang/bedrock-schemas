 ...
 * 
 * minecraft:float_property Samples
 * At Full..: 
...
/**
 * Float Property (float_property)
 * Returns true when the float actor property matches the value
 * provided.
 */
export default interface FloatProperty {
...
export enum FloatPropertyOperator {
  /**
   * @remarks
   * Test for inequality.
   */
...
export enum FloatPropertySubject {
  /**
   * @remarks
