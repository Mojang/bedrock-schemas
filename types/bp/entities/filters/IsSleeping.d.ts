 ...
 * 
 * Entity Filters Documentation - minecraft:is_sleeping
 * 
 * minecraft:is_sleeping Samples
 * At Full..: 
 ...
 */
export default interface IsSleeping {
...
export enum IsSleepingOperator {
  /**
   * @remarks
   * Test for inequality.
   */
