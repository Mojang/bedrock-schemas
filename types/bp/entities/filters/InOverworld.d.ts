 ...
 * 
 * minecraft:in_overworld Samples
 * At Full..: 
 ...
 */
export default interface InOverworld {
...
export enum InOverworldOperator {
  /**
   * @remarks
   * Test for inequality.
   */
...
export enum InOverworldSubject {
  /**
   * @remarks
