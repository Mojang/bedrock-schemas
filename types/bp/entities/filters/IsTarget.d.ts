...
/**
 * Is Target (is_target)
 * Returns true if the subject entity is the target of the calling
 * entity.
 * Note: Does not require any parameters to work properly. It can
 * be used as a standalone filter.
 */
export default interface IsTarget {
