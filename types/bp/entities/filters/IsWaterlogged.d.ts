 ...
 * 
 * minecraft:is_waterlogged Samples
 * At Full..: 
...
/**
 * Is Waterlogged (is_waterlogged)
 * Tests if the subject block is submerged in water.
 */
export default interface IsWaterlogged {
...
export enum IsWaterloggedOperator {
  /**
   * @remarks
   * Test for inequality.
   */
...
export enum IsWaterloggedSubject {
  /**
   * @remarks
