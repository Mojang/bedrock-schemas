 ...
 * 
 * minecraft:is_in_village Samples
 * At Full..: 
 ...
 */
export default interface IsInVillage {
...
export enum IsInVillageOperator {
  /**
   * @remarks
   * Test for inequality.
   */
...
export enum IsInVillageSubject {
  /**
   * @remarks
