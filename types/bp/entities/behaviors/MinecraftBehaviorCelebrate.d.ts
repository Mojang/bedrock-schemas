...
/**
 * Entity Celebrate Behavior (minecraft:behavior.celebrate)
...
export default interface MinecraftBehaviorCelebrate {
   ...
   */
  on_celebration_end_event?: MinecraftBehaviorCelebrateOnCelebrationEndEvent;
...
export enum MinecraftBehaviorCelebrateCelebrationSound {
...
export enum MinecraftBehaviorCelebrateControlFlags {
  jump = `jump`,
  look = `look`,
  move = `move`
}
 ...
 * gameplay.
 */
export interface MinecraftBehaviorCelebrateOnCelebrationEndEvent {
   ...
   */
  filters?: MinecraftBehaviorCelebrateOnCelebrationEndEventFilters;
 ...
 * Filters (filters)
 */
export interface MinecraftBehaviorCelebrateOnCelebrationEndEventFilters {
...
export enum MinecraftBehaviorCelebrateOnCelebrationEndEventTarget {
  baby = `baby`,
  block = `block`,
  damager = `damager`,
  holder = `holder`,
