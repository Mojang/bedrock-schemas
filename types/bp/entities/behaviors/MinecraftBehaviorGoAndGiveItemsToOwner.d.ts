 ...
 * 
 * Entity Behaviors Documentation - minecraft:behavior.go_and_give_items_to_owner
 * 
...
/**
 * Entity Go And Give Items To Owner Behavior
 * (minecraft:behavior.go_and_give_items_to_owner)
...
export default interface MinecraftBehaviorGoAndGiveItemsToOwner {
   ...
   *
   */
  on_item_throw?: MinecraftBehaviorGoAndGiveItemsToOwnerOnItemThrow[];
...
export enum MinecraftBehaviorGoAndGiveItemsToOwnerControlFlags {
  jump = `jump`,
  look = `look`,
  move = `move`
}
 ...
 * gameplay.
 */
export interface MinecraftBehaviorGoAndGiveItemsToOwnerOnItemThrow {
   ...
   */
  filters?: MinecraftBehaviorGoAndGiveItemsToOwnerOnItemThrowFilters;
 ...
 * Filters (filters)
 */
export interface MinecraftBehaviorGoAndGiveItemsToOwnerOnItemThrowFilters {
...
export enum MinecraftBehaviorGoAndGiveItemsToOwnerOnItemThrowTarget {
  baby = `baby`,
  block = `block`,
  damager = `damager`,
  holder = `holder`,
...
export enum MinecraftBehaviorGoAndGiveItemsToOwnerThrowSound {
