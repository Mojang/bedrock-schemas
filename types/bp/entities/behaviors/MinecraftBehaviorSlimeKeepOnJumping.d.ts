 ...
 * 
 * Entity Behaviors Documentation - minecraft:behavior.slime_keep_on_jumping
 * 
...
/**
 * Entity Slime Keep On Jumping Behavior
 * (minecraft:behavior.slime_keep_on_jumping)
...
export enum MinecraftBehaviorSlimeKeepOnJumpingControlFlags {
  jump = `jump`,
  look = `look`,
  move = `move`
}