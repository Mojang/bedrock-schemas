 ...
 * 
 * Entity Behaviors Documentation - minecraft:behavior.go_and_give_items_to_noteblock
 * 
...
/**
 * Entity Go And Give Items To Noteblock Behavior
 * (minecraft:behavior.go_and_give_items_to_noteblock)
...
export default interface MinecraftBehaviorGoAndGiveItemsToNoteblock {
   ...
   *
   */
  on_item_throw?: MinecraftBehaviorGoAndGiveItemsToNoteblockOnItemThrow[];
...
export enum MinecraftBehaviorGoAndGiveItemsToNoteblockControlFlags {
  jump = `jump`,
  look = `look`,
  move = `move`
}
 ...
 * gameplay.
 */
export interface MinecraftBehaviorGoAndGiveItemsToNoteblockOnItemThrow {
   ...
   */
  filters?: MinecraftBehaviorGoAndGiveItemsToNoteblockOnItemThrowFilters;
 ...
 * Filters (filters)
 */
export interface MinecraftBehaviorGoAndGiveItemsToNoteblockOnItemThrowFilters {
...
export enum MinecraftBehaviorGoAndGiveItemsToNoteblockOnItemThrowTarget {
  baby = `baby`,
  block = `block`,
  damager = `damager`,
  holder = `holder`,
...
export enum MinecraftBehaviorGoAndGiveItemsToNoteblockThrowSound {
