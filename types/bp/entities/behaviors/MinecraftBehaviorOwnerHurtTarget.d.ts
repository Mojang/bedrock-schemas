 ...
 * 
 * Entity Behaviors Documentation - minecraft:behavior.owner_hurt_target
 * 
...
/**
 * Entity Owner Hurt Target Behavior
...
export enum MinecraftBehaviorOwnerHurtTargetControlFlags {
  jump = `jump`,
  look = `look`,
  move = `move`
}
