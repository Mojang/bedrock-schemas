...
/**
 * Entity Delayed Attack Behavior 
...
export default interface MinecraftBehaviorDelayedAttack {
   ...
   * attacks.
   */
  on_attack?: MinecraftBehaviorDelayedAttackOnAttack;
   ...
   * target.
   */
  on_kill?: MinecraftBehaviorDelayedAttackOnKill;
...
export enum MinecraftBehaviorDelayedAttackControlFlags {
  jump = `jump`,
  look = `look`,
  move = `move`
}
 ...
 * gameplay.
 */
export interface MinecraftBehaviorDelayedAttackOnAttack {
   ...
   */
  filters?: MinecraftBehaviorDelayedAttackOnAttackFilters;
 ...
 * Filters (filters)
 */
export interface MinecraftBehaviorDelayedAttackOnAttackFilters {
...
export enum MinecraftBehaviorDelayedAttackOnAttackTarget {
  baby = `baby`,
  block = `block`,
  damager = `damager`,
  holder = `holder`,
 ...
 * gameplay.
 */
export interface MinecraftBehaviorDelayedAttackOnKill {
   ...
   * combination of these objects.
   */
  filters?: MinecraftBehaviorDelayedAttackOnKillFilters;
 ...
 * Filters (filters)
 */
export interface MinecraftBehaviorDelayedAttackOnKillFilters {
...
export enum MinecraftBehaviorDelayedAttackOnKillTarget {
  baby = `baby`,
  block = `block`,
  damager = `damager`,
  holder = `holder`,
...
export enum MinecraftBehaviorDelayedAttackSoundEvent {
