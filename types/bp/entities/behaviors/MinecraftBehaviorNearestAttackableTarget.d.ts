 ...
 * 
 * Entity Behaviors Documentation - minecraft:behavior.nearest_attackable_target
 * 
...
/**
 * Entity Nearest Attackable Target Behavior
 * (minecraft:behavior.nearest_attackable_target)
...
export default interface MinecraftBehaviorNearestAttackableTarget {
   ...
   * 
   * Sample Values:
   * Blaze: [{"filters":{"AND":[{"test":"is_family","subject":1,"operator":0,"value":"player"}]},"max_dist":48}]
   *
   * Bogged: [{"filters":{"test":"is_family","subject":"other","value":"player"}},{"filters":{"test":"is_family","subject":"other","value":"irongolem"}},{"filters":{"all_of":[{"test":"is_family","subject":"other","value":"baby_turtle"},{"test":"in_water","subject":"other","operator":"!=","value":true}]}}]
   *
   * Breeze: [{"filters":{"AND":[{"test":"is_family","subject":1,"operator":0,"value":"player"}]},"max_dist":24},{"filters":{"AND":[{"test":"is_family","subject":1,"operator":0,"value":"irongolem"}]},"max_dist":24}]
   *
   */
