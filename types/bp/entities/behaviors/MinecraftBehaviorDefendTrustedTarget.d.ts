...
/**
 * Entity Defend Trusted Target Behavior
...
export default interface MinecraftBehaviorDefendTrustedTarget {
   ...
   */
  on_defend_start?: MinecraftBehaviorDefendTrustedTargetOnDefendStart;
...
export enum MinecraftBehaviorDefendTrustedTargetAggroSound {
...
export enum MinecraftBehaviorDefendTrustedTargetControlFlags {
  jump = `jump`,
  look = `look`,
  move = `move`
}
 ...
 * gameplay.
 */
export interface MinecraftBehaviorDefendTrustedTargetOnDefendStart {
   ...
   */
  filters?: MinecraftBehaviorDefendTrustedTargetOnDefendStartFilters;
 ...
 * Filters (filters)
 */
export interface MinecraftBehaviorDefendTrustedTargetOnDefendStartFilters {
...
export enum MinecraftBehaviorDefendTrustedTargetOnDefendStartTarget {
  baby = `baby`,
  block = `block`,
  damager = `damager`,
  holder = `holder`,
