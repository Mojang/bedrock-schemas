 ...
 * 
 * Entity Behaviors Documentation - minecraft:behavior.follow_caravan
 * 
...
export default interface MinecraftBehaviorFollowCaravan {
  ...
  /**
   * @remarks
   * List of entity types that this mob can follow in a caravan. Can
   * be a single filter object or an array of filter objects.
   * 
   * Sample Values:
