 ...
 * 
 * Entity Behaviors Documentation - minecraft:behavior.ram_attack
 * 
...
/**
 * Entity Ram Attack Behavior (minecraft:behavior.ram_attack)
...
export enum MinecraftBehaviorRamAttackControlFlags {
  jump = `jump`,
  look = `look`,
  move = `move`
}
 ...
 * gameplay.
 */
export interface MinecraftBehaviorRamAttackOnStart {
   ...
   */
  filters?: MinecraftBehaviorRamAttackOnStartFilters;
 ...
 * Filters (filters)
 */
export interface MinecraftBehaviorRamAttackOnStartFilters {
...
export enum MinecraftBehaviorRamAttackOnStartTarget {
  baby = `baby`,
  block = `block`,
  damager = `damager`,
  holder = `holder`,
