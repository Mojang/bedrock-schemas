 ...
 * 
 * Entity Behaviors Documentation - minecraft:behavior.charge_attack
 * 
...
export enum MinecraftBehaviorChargeAttackControlFlags {
  jump = `jump`,
  look = `look`,
  move = `move`
}
...
export enum MinecraftBehaviorChargeAttackSoundEvent {
