...
/**
 * Entity Avoid Block Behavior (minecraft:behavior.avoid_block)
...
export enum MinecraftBehaviorAvoidBlockControlFlags {
  jump = `jump`,
  look = `look`,
  move = `move`
}
 ...
 * gameplay.
 */
export interface MinecraftBehaviorAvoidBlockOnEscape {
   ...
   */
  filters?: MinecraftBehaviorAvoidBlockOnEscapeFilters;
 ...
 * Filters (filters)
 */
export interface MinecraftBehaviorAvoidBlockOnEscapeFilters {
...
export enum MinecraftBehaviorAvoidBlockOnEscapeTarget {
  baby = `baby`,
  block = `block`,
  damager = `damager`,
  holder = `holder`,
