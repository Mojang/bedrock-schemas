 ...
 * 
 * Entity Behaviors Documentation - minecraft:behavior.lay_egg
 * 
...
/**
 * Entity Lay Egg Behavior (minecraft:behavior.lay_egg)
...
export default interface MinecraftBehaviorLayEgg {
   ...
   *
   */
  on_lay?: MinecraftBehaviorLayEggOnLay;
  ...
  /**
   * @remarks
   * The height in blocks the mob will look for the block to move
   * towards.
   * 
   * Sample Values:
   * Frog: 3
  ...
  /**
   * @remarks
   * The distance in blocks it will look for the block to move
   * towards.
   * 
   * Sample Values:
   * Frog: 10
...
export enum MinecraftBehaviorLayEggControlFlags {
  jump = `jump`,
  look = `look`,
  move = `move`
}
...
export enum MinecraftBehaviorLayEggLayEggSound {
 ...
 * gameplay.
 */
export interface MinecraftBehaviorLayEggOnLay {
   ...
   */
  filters?: MinecraftBehaviorLayEggOnLayFilters;
 ...
 * Filters (filters)
 */
export interface MinecraftBehaviorLayEggOnLayFilters {
...
export enum MinecraftBehaviorLayEggOnLayTarget {
  baby = `baby`,
  block = `block`,
  damager = `damager`,
  holder = `holder`,
