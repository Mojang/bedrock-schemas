 ...
 * 
 * Entity Components Documentation - minecraft:environment_sensor
 * 
 * minecraft:environment_sensor Samples
...
/**
 * Environment Sensor (minecraft:environment_sensor)
 * Creates a trigger based on environment conditions.
 */
export default interface MinecraftEnvironmentSensor {

  /**
   * @remarks
   * The list of triggers that fire when the environment conditions match
   * the given filter criteria. Can be an array of trigger objects or
   * a single trigger object.
   * 
   * Sample Values:
   * Breeze: [{"event":"minecraft:stop_playing_idle_ground_sound","filters":{"all_of":[{"subject":"self","test":"on_ground","value":true},{"subject":"self","test":"has_target","value":true},{"domain":"minecraft:is_playing_idle_ground_sound","operator":"==","test":"bool_property"}]}},{"event":"minecraft:start_playing_idle_ground_sound","filters":{"all_of":[{"domain":"minecraft:is_playing_idle_ground_sound","operator":"!=","test":"bool_property"},{"any_of":[{"subject":"self","test":"on_ground","value":false},{"subject":"self","test":"has_target","value":false}]}]}}]
   *
   * Cave Spider: {"event":"minecraft:become_neutral","filters":{"operator":">","test":"is_brightness","value":0.49}}, {"event":"minecraft:become_hostile","filters":{"operator":"<","test":"is_brightness","value":0.49}}
   *
   */
  triggers?: object[];
