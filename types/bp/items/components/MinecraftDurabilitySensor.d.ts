 ...
 * 
 * Item Components Documentation - minecraft:durability_sensor
 */
...
export enum MinecraftDurabilitySensorDurabilityThresholdsParticleType {
...
export enum MinecraftDurabilitySensorDurabilityThresholdsSoundEvent {
