 ...
 * 
 * Item Components Documentation - minecraft:item_v1_21_90
 */

import * as jsoncommon from '../../../common';

/**
 * Item 21.90 Item v1 (minecraft:item v1.21.90)
 * Item definition includes the "description" and "components" 
 * sections.
 */
export default interface MinecraftItemV12190 {

  /**
   * @remarks
   * List of all components used in this item.
   */
  components?: MinecraftItemV12190Components;
   ...
   */
  description: MinecraftItemV12190Description;
 ...
 * List of all components used in this item.
 */
export interface MinecraftItemV12190Components {
...
This component can also be used instead of the
   ...
   * the item icon.
   */
  "minecraft:block_placer"?: MinecraftItemV12190ComponentsMinecraftBlockPlacer;
   ...
   */
  "minecraft:bundle_interaction"?: MinecraftItemV12190ComponentsMinecraftBundleInteraction;
   ...
   */
  "minecraft:compostable"?: MinecraftItemV12190ComponentsMinecraftCompostable;
   ...
   */
  "minecraft:cooldown"?: MinecraftItemV12190ComponentsMinecraftCooldown;
   ...
   * component.
   */
  "minecraft:damage_absorption"?: MinecraftItemV12190ComponentsMinecraftDamageAbsorption;
   ...
   * specific blocks.
   */
  "minecraft:digger"?: MinecraftItemV12190ComponentsMinecraftDigger;
   ...
   */
  "minecraft:display_name"?: MinecraftItemV12190ComponentsMinecraftDisplayName;
   ...
   */
  "minecraft:durability"?: MinecraftItemV12190ComponentsMinecraftDurability;
   ...
   * component.
   */
  "minecraft:durability_sensor"?: MinecraftItemV12190ComponentsMinecraftDurabilitySensor;

  "minecraft:dyeable"?: MinecraftItemV12190ComponentsMinecraftDyeable;
   ...
   * all item components.
   */
  "minecraft:enchantable"?: MinecraftItemV12190ComponentsMinecraftEnchantable;
   ...
   */
  "minecraft:entity_placer"?: MinecraftItemV12190ComponentsMinecraftEntityPlacer;
   ...
   */
  "minecraft:food"?: MinecraftItemV12190ComponentsMinecraftFood;
   ...
   */
  "minecraft:projectile"?: MinecraftItemV12190ComponentsMinecraftProjectile;
   ...
   */
  "minecraft:record"?: MinecraftItemV12190ComponentsMinecraftRecord;
   ...
   * gained.
   */
  "minecraft:repairable"?: MinecraftItemV12190ComponentsMinecraftRepairable;

  /**
   * @remarks
   * Shooter Item Component.
   */
  "minecraft:shooter"?: MinecraftItemV12190ComponentsMinecraftShooter;
   ...
   */
  "minecraft:storage_item"?: MinecraftItemV12190ComponentsMinecraftStorageItem;
   ...
   * hold
   */
  "minecraft:storage_weight_limit"?: MinecraftItemV12190ComponentsMinecraftStorageWeightLimit;
   ...
   * hold
   */
  "minecraft:storage_weight_modifier"?: MinecraftItemV12190ComponentsMinecraftStorageWeightModifier;

  /**
   * @remarks
   * The tags component specifies which tags an item has on it.
   */
  "minecraft:tags"?: MinecraftItemV12190ComponentsMinecraftTags;
   ...
   * snowball.
   */
  "minecraft:throwable"?: MinecraftItemV12190ComponentsMinecraftThrowable;
   ...
   */
  "minecraft:use_modifiers"?: MinecraftItemV12190ComponentsMinecraftUseModifiers;
   ...
   */
  "minecraft:wearable"?: MinecraftItemV12190ComponentsMinecraftWearable;
 ...
 * as the icon.
 */
export interface MinecraftItemV12190ComponentsMinecraftBlockPlacer {
 ...
 * Use On (use_on)
 */
export interface MinecraftItemV12190ComponentsMinecraftBlockPlacerUseOn {
 ...
 * creating a composting layer in the composter.
 */
export interface MinecraftItemV12190ComponentsMinecraftCompostable {
 ...
 */
export interface MinecraftItemV12190ComponentsMinecraftCooldown {
...
export enum MinecraftItemV12190ComponentsMinecraftCooldownType {
  attack = `attack`,
  use = `use`
}
 ...
 * component.
 */
export interface MinecraftItemV12190ComponentsMinecraftDamageAbsorption {
 ...
 */
export interface MinecraftItemV12190ComponentsMinecraftDigger {
   ...
   */
  destroy_speeds?: MinecraftItemV12190ComponentsMinecraftDiggerDestroySpeeds[];
...
export interface MinecraftItemV12190ComponentsMinecraftDiggerDestroySpeeds {
   ...
   * Block to be dug.
   */
  block: MinecraftItemV12190ComponentsMinecraftDiggerDestroySpeedsBlock;
 ...
 * Block (block)
 */
export interface MinecraftItemV12190ComponentsMinecraftDiggerDestroySpeedsBlock {
 ...
 */
export interface MinecraftItemV12190ComponentsMinecraftDisplayName {
 ...
 * crafting table.
 */
export interface MinecraftItemV12190ComponentsMinecraftDurability {
...
export interface MinecraftItemV12190ComponentsMinecraftDurabilitySensor {
   ...
   * considered.
   */
  durability_thresholds: MinecraftItemV12190ComponentsMinecraftDurabilitySensorDurabilityThresholds[];
 ...
 */
export interface MinecraftItemV12190ComponentsMinecraftDurabilitySensorDurabilityThresholds {
...
export enum MinecraftItemV12190ComponentsMinecraftDurabilitySensorDurabilityThresholdsParticleType {
...
export enum MinecraftItemV12190ComponentsMinecraftDurabilitySensorDurabilityThresholdsSoundEvent {
 ...
 */
export interface MinecraftItemV12190ComponentsMinecraftEnchantable {
 ...
 */
export interface MinecraftItemV12190ComponentsMinecraftEntityPlacer {
   ...
   */
  dispense_on?: MinecraftItemV12190ComponentsMinecraftEntityPlacerDispenseOn[];
 ...
 */
export interface MinecraftItemV12190ComponentsMinecraftEntityPlacerDispenseOn {
 ...
 * Use On (use_on)
 */
export interface MinecraftItemV12190ComponentsMinecraftEntityPlacerUseOn {
 ...
 * the player.
 */
export interface MinecraftItemV12190ComponentsMinecraftFood {
 ...
 */
export interface MinecraftItemV12190ComponentsMinecraftProjectile {
...
export enum MinecraftItemV12190ComponentsMinecraftRecordSoundEvent {
  absorbBlock = `absorb_block`,
  activate = `activate`,
  addChest = `add.chest`,
  admire = `admire`,
 ...
 */
export interface MinecraftItemV12190ComponentsMinecraftRepairable {
 ...
 */
export interface MinecraftItemV12190ComponentsMinecraftShooter {
 ...
 * durations.
 */
export interface MinecraftItemV12190ComponentsMinecraftThrowable {
...
export enum MinecraftItemV12190ComponentsMinecraftUseModifiersStartSound {
  absorbBlock = `absorb_block`,
  activate = `activate`,
  addChest = `add.chest`,
  admire = `admire`,
...
export enum MinecraftItemV12190ComponentsMinecraftUseModifiersStartUsing {
  always = `always`,
  ifFirst = `if_first`
}
...
export enum MinecraftItemV12190ComponentsMinecraftWearableSlot {
 ...
 * fields like menu_category.
 */
export interface MinecraftItemV12190Description {
   ...
   * this item.
   */
  menu_category?: MinecraftItemV12190DescriptionMenuCategory;
 ...
 * this item.
 */
export interface MinecraftItemV12190DescriptionMenuCategory {
...
export enum MinecraftItemV12190DescriptionMenuCategoryCategory {
